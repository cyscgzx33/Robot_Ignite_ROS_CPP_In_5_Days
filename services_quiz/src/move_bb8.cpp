...
namespace srv_sqr_traj {
    move_bb8::move_bb8() {
        ...
        // Specification: the name of the Service will be "/move_bb8_in_square_custom"
        srv_perform_square_ = nh_.advertiseService("/move_bb8_in_square_custom", &move_bb8::cbfunc, this);
